...
The Missing Salmon Alliance is developing its’ Likely Suspects Framework programme to coordinate efforts to collate and mobilise relevant datasets from around the North Atlantic to facilitate testing hypotheses relating to drivers of salmon mortality. We are building a unique data resource utilizing variable categories and search tools to help researchers explore and utilize data from a wide range of sources.  
...
### Data Access Audit
Access history and actions (e.g., submit resource, request resource) will be audited per user within the framework to keep a record of usage statistics and also assist users to keep track of historical activity.  
